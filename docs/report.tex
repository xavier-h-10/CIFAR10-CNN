...
\begin{table}[h]
	\begin{tabular}{|l|l|l|l|l|l|l|}
		...
		resnet18-tf & Nvidia 2080Ti & 134.16 MB  & 100    & 32         &              &          \\ \hline
		inception10 & Nvidia 2080Ti & 1.51 MB    & 100    & 32         &              &          \\ \hline
	\end{tabular}
\end{table}
\\
\indent
我们借此快速了解了各个模型的特点和能力，选择了ResNet继续研究。下图是这些模型的准确度，损失函数对于Epochs的图像：
\begin{figure}[H]
	\centering
	\subfigure[Alex8Net]{
		\centering
